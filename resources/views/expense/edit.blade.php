        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-card dark:bg-gray-800 overflow-hidden shadow-sm rounded-xl border border-gray-100 dark:border-gray-700">
                <div class="p-6 sm:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('expense.update', $expense) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <x-text-input id="amount" class="block w-full pl-8" type="number" step="0.01" min="0.01" name="amount" :value="old('amount', $expense->amount)" required placeholder="0.00" />
                            </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="transaction_date" class="block mt-1 w-full" type="date" name="transaction_date" :value="old('transaction_date', $expense->transaction_date->format('Y-m-d'))" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="description" class="block mt-1 w-full" type="text" name="description" :value="old('description', $expense->description)" placeholder="e.g. Grocery run" />
