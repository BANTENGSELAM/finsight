    ...
    <div class="py-12" x-data="{ showDeleteModal: false, deleteUrl: '' }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Expenses</h2>

                <div class="flex items-center gap-4">
                    <form method="GET" action="{{ route('expense.index') }}" class="flex items-center relative">
                        <x-text-input type="text" name="search" value="{{ request('search') }}" placeholder="Search expenses..." class="pl-10 pr-4 py-2 w-full sm:w-64" />
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse($expenses as $expense)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center text-gray-900 dark:text-gray-100">
                                            @if($expense->category->icon)
                                                <div class="w-8 h-8 rounded-full bg-red-50 dark:bg-gray-700 text-danger flex items-center justify-center mr-3">
                                    ...
                                    <td class="px-6 py-4 text-right font-bold text-danger">
                                        -${{ number_format($expense->amount, 2) }}
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-3">
                                            <a href="{{ route('expense.edit', $expense) }}" class="text-blue-500 hover:text-blue-700 transition">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                            </a>
                                            <button @click="showDeleteModal = true; deleteUrl = '{{ route('expense.destroy', $expense) }}'" class="text-danger hover:text-red-700 transition">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-sm mt-1">Get started by adding your first expense.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                    ...
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100" id="modal-title">Delete Expense Record</h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Are you sure you want to delete this expense record? This action cannot be undone and will affect your balance.</p>
                                </div>
                            </div>
                        </div>
                    </div>
