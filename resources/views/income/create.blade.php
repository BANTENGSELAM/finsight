        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Add Income</h2>
                </div>
            </div>
                ...
                <div class="p-6 sm:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('income.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="description" class="block mt-1 w-full" type="text" name="description" :value="old('description')" placeholder="e.g. Monthly Salary" />
